...
== Events/Observables
If you are dealing with asynchronous datasources - async await, task, events - always hand them to your users as Observables. See link:/en/reference/libraries/writing-nodes.adoc#_Observables[Writing Nodes].
