...
* Integer32
* Float32
* Vector2/3/4 of https://www.nuget.org/packages/SharpDX.Mathematics/[SharpDX.Mathematics]
* Matrix of https://www.nuget.org/packages/SharpDX.Mathematics/[SharpDX.Mathematics]
* Char
* String
* Path
* Spread<T>
