...
== Prepare
Drop some Groups onto your document canvas and name them to make up the main categories.
Navigate into them.
...
* Drag your type into a group patch

You now can navigate into the forwarded type to adjust which nodes should get imported or to adjust further details of the type.
