...
This is basically it. Now build the project and you'll get a managed .dll containing your nodes. From here you continue with link:/reference/libraries/using-net-libraries.adoc[Using .NET Libraries] to use those operations as nodes in VL.
