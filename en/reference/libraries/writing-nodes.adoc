image:/assets/vl-libraries-writingNodes-DynamicEnums.png[alt=""]:experimental:
:figure-caption!:
...
==== Implementing dynamic Enums in VL
...
===== 4. Specify a default constructor
...
. Choose _'Imports'_ in the dropdown and use the treeview to navigate to your 'MyEnum' class. 
...
image::/assets/vl-libraries-writingNodes-DynamicEnums-CreateDefault.png[]
...
image::/assets/vl-libraries-writingNodes-DynamicEnums.png[]
