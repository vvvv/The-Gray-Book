...
In VisualStudio (2015 or 2017) create a new project by choosing either of those two templates:

- Visual C# > Class Library (.NET Standard) (Visual Studio 2017 only!)
