...
. Unfolding it you should see the 'MyEnum' type which you can drag-drop onto the document patch. This makes the enum available for the VL type system and allows it to initialize the type, whenever it encounters the type `MyEnum`.
