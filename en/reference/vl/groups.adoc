Groups allow you to organize operations and datatypes in a document. Instead of placing all elements directly in a Document Patch you can use groups to structure your program.
