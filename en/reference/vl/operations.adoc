...
image::../../images/vl-Operations-Static-NodeBrowser.png[]
...
image::../../images/vl-Utils-StaticOperation-GenericToggle.png[]
...
image::../../images/vl-Operations-Static-MyOperation-NodeBrowser.png[]
