...
*Image:Choose to create an operation definition in the NodeBrowser*
...
*Image:The _Is Generic_ toggle of an operation definition is on by default*

Once created, the operation definition shows up in the NodeBrowser and can now be created as a node.

*Image:The newly created operation can now be selected via the NodeBrowser*
