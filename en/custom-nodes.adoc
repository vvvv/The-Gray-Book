...
=== Datatypes
In VL you can also use any datatype you define as a class or struct in c#. in your can also understand your datatypes 
Any constructor will be available as a Create node. 
Any public member operation will be available as an individual node in VL. Private or Protected operations will be ignored.
...
Do public fields/properties turn into getters?
