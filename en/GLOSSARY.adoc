...
== Pad
Common term for visual elements which represent a single data source or sink. Namely Inlet/Outlet, Reader/Writer, Accumulator Reader/Writer and constants.
