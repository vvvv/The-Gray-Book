...
- Creating a new C#-File via the Wizard now autogenerates filenames without spaces, adds "Utils" instead of ".Utils" to the .csproj file and makes sure to not add superfluous .csproj files 
