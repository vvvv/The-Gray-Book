...
* ToChannel node now can be forced to push "unchanged values" [forum](https://discourse.vvvv.org/t/observable-unit-tochannel/22681)
...
* Fixes issues with enum popups not having the correct z-drawing index in a patch [forum](https://discourse.vvvv.org/t/dropdowns-within-spread-get-occluded/22735/2) [forum](https://discourse.vvvv.org/t/node-character-is-drawn-over-enum-list/18995/2) [forum](https://discourse.vvvv.org/t/enum-dropdown-drawing-order-in-ui/21876/1)
* Frames created via the nodebrowser now appear at the correct location [forum](https://discourse.vvvv.org/t/ui-frame-create-with-y-offset-of-cursor-position/22742/2)
* Fixes an issue with labels on definition nodes that could be unintentionally edited [forum](https://discourse.vvvv.org/t/definition-node-extra-textinput/22729/2)
* TryParse (String) now returns false in case of NULL on input
  
### New
* Shortcuts to change font size of IOBoxes/Comments: Alt+1 through Alt+6 [forum](https://discourse.vvvv.org/t/shortcut-to-increase-decrease-font-size-of-iobox/21553/7)
...
### Libraries
#### Stride
* TextureWriter now saves files on render [forum](https://discourse.vvvv.org/t/incremental-mainloop-texturewriter-dont-wait-for-rendering-to-finish/22708/2)
...
* Fixes potential lag/mini freeze of UI when changing values in patch - [forum](https://discourse.vvvv.org/t/iobox-freeze-bug/22594/3)
...
* Fixes inconsistency with default values on pin groups in exported code - [forum](https://discourse.vvvv.org/t/pin-groups-doesnt-stores-values-after-exporting-in-very-specific-case/22670/2)
...
* IOBoxes with Spreads: fixes CollectionEditor not applying the settings to new editors when increasing editor count - [forum](https://discourse.vvvv.org/t/iobox-not-showing-slider-when-changing-the-spread-count/22535)
...
* Fixes runtime crash (CastException) when connecting `Object` to `Optional<T>` -  [forum](https://discourse.vvvv.org/t/globalchannelpreseter/22505/2)
* Fixes bangs getting stuck when used in spread editors - [forum](https://discourse.vvvv.org/t/iobox-bool-bang-glitch/22625/1)
...
### Changes
* SaveAll command will only save documents with actual user changes - [forum](https://discourse.vvvv.org/t/untouched-files-are-saved-with-save-all/22490)

### Fixes
* Ensures `UseWindowsForms` is set in exported entry point project when output type is `WinExe` - [forum](https://discourse.vvvv.org/t/windowsformsapphost-missing-usewindowsforms-property/22553/3)
* Fixes spreaded press/bang IO box no longer working correctly. Regression introduced with 6.0 - [forum](https://discourse.vvvv.org/t/problem-with-spread-of-bool-press/22565)
* Fixes a regression in `ForEach [Reactive]` introduced with 6.0 - [forum](https://discourse.vvvv.org/t/reactive-retry-bug/22580/7)
* VL.IO.Midi: fixes issue with ControllerState node not properly responding to channel changes - [forum](https://discourse.vvvv.org/t/midi-bug-with-controllerstate-node/22545)
* VL.IO.ArtNet: reworked to fix two issues: [forum](https://discourse.vvvv.org/t/artnet-not-working-on-recent-previews/22492/3), [forum](https://discourse.vvvv.org/t/artnet-sending-multiple-universes-spreadable-artnet-sender/22245)
* VL.Audio: fixed regression with Audio config UI not working in export - [forum](https://discourse.vvvv.org/t/vl-audio-ui-export-bug-in-vvvv-gamma-6-2/22583/2)
* VL.Pipette.HDE: working again with 6.x - [forum](https://discourse.vvvv.org/t/hde-pipette-not-working-with-6-2/22579)
