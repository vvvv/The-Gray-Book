...
- Send & Receive nodes refined
	...
	- `Send (Local)` region + `R (Local)` nodes were added for better support of scopes. Values are only receivable in a defined area of the patch. Reasoning about execution order is not necessary.
