...
#### Changes
- Moves `NameAttribute` to public `VL.Core.Import` namespace - allows to name symbols differently in VL than in dotnet - [forum](https://forum.vvvv.org/t/generic-interface-with-unigeneric-version-importasis/25075)
...
- Fixes C# written process nodes not inheriting smell from parent category
- Fixes "new version available" button not showing up (was introduced in 7.0)
