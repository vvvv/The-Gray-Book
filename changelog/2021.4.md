...
[Installer](https://teamcity.vvvv.org/guestAuth/app/rest/builds/id:36679/artifacts/content/vvvv_gamma_2021.4.12_setup.exe) |
[Offline Installer](https://teamcity.vvvv.org/guestAuth/app/rest/builds/id:36679/artifacts/content/vvvv_gamma_2021.4.12_setup_offline.exe)

### Fixes
* Fixes `LottiePlayer (Skia)`, now smoothly playing animations. Also added `LottiePlayer (Framebased Skia)` - [forum](https://forum.vvvv.org/t/lottie-playback-not-working-correctly/21006)
...
* Fixes Settings > Themes. Default and Custom themes are better separated - [forum](https://forum.vvvv.org/t/when-you-add-custom-themes-the-default-themes-are-also-replaced/21019)
...
[Installer](https://teamcity.vvvv.org/guestAuth/app/rest/builds/id:36569/artifacts/content/vvvv_gamma_2021.4.11_setup.exe) |
[Offline Installer](https://teamcity.vvvv.org/guestAuth/app/rest/builds/id:36569/artifacts/content/vvvv_gamma_2021.4.11_setup_offline.exe)

### New
* You can now [play Lottie files](https://visualprogramming.net/blog/2022/introducing-lottie/) with Skia 
* You can now [share screenshots](https://visualprogramming.net/blog/2022/introducing-show-tell) of your work to our [collective gallery](https://pixelfed.social/madewithvvvv). Use Ctrl+3.
* You can now take screenshots of Skia and Stride renderers. Use Ctrl+2.
* New command line option to specify the primary package folder via `--nuget-path` - [forum](https://forum.vvvv.org/t/vvvv-projects-self-contained-vs-global-package-repositories/20754/10)
...
* Thanks to a new hotswap friendly target code, pressure on the garbage collector is reduced drastically, fixing lot's of glitches/dropouts while running inside of the patch editor. Exported apps are not affected by this change - [forum](https://forum.vvvv.org/t/total-frame-drop-out-including-audio-dropout-glitching/20701/11)
...
* Fixes `ReleaseAndDispose` mode of `SingleInstance` region not working in exported apps - [forum](https://forum.vvvv.org/t/exported-application-hangs-on-exit-when-using-vl-io-mousekeyglobal/20840)
* Fixes & documents `StoreSequence` node
* Fixes exception when creating a dictionary pin group and an internal equality check leading to endless compile loop - [forum](https://forum.vvvv.org/t/dynamic-inputs-cause-gamma-to-crash-in-a-very-strange-way/20748/3)
...
* Fixes seek time not being passed to image player when running without time sync - [forum](https://forum.vvvv.org/t/imageplayer-stride-doesnt-preload-correctly/20956)
* Fixes regions created with the `Surround` command not being replaceable - [forum](https://forum.vvvv.org/t/its-not-possible-to-replace-regions-that-have-been-created-with-surround/20930/2)
...
### Stride
* Improvements for 3d and 2d primitives, see [PR1](https://github.com/vvvv/VL.Stride/pull/561) and [PR2](https://github.com/vvvv/VL.Stride/pull/573) and [PR3](https://github.com/vvvv/VL.Stride/pull/574)
...
[Installer](https://teamcity.vvvv.org/guestAuth/app/rest/builds/id:36032/artifacts/content/vvvv_gamma_2021.4.10_setup.exe) |
[Offline Installer](https://teamcity.vvvv.org/guestAuth/app/rest/builds/id:36032/artifacts/content/vvvv_gamma_2021.4.10_setup_offline.exe)
...
* Fixes vvvv.exe not properly shutting down - [forum](https://forum.vvvv.org/t/iresourceprovider-seems-not-to-dispose-resource/20676/3)
...
* Fixes FSPickler exception when sending spread of data from exported app to editor [forum](https://forum.vvvv.org/t/binary-serialisation-and-networks/19579/20)
* Outboxes will unsubscribe on runtime stop [forum](https://forum.vvvv.org/t/texture-previews-broken-after-reopening-file/20391)
* Fixes some seeking issues in VL.Video [forum](https://forum.vvvv.org/t/video-mediafoundation-scrubbing-seeking-behaviour/20432)
* Fixes naming of generated projects in release builds. For example we'll now correctly see VL.CoreLib.vl (and not VL.XML.vl)
* Fixes exception pop-up when double clicking certain nodes [forum](https://forum.vvvv.org/t/exception-when-trying-to-replace-effect-node/20490)
...
### Stride
* Fixes regression when exporting Stride applications - some models weren't loaded anymore [forum](https://forum.vvvv.org/t/exported-app-trouble-loading-model-textures/20447/2)
...
### Fixes
* Fixes region not showing error on unsupported border control points - [forum](https://forum.vvvv.org/t/when-cache-changed-to-if-region-the-accumulators-show-as-boxes/20298)
...
* No longer overwrite a document which is already open - [forum](https://forum.vvvv.org/t/overwriting-an-open-document-leads-to-exception/20301)
...
### Fixes
* Fixes `Pipet` node [forum](https://forum.vvvv.org/t/stridepipet-broken-in-gammastable2021-4-6/20198/2)
...
* User defined records will be emitted with proxies and therefor take part in hotswap - [forum](https://forum.vvvv.org/t/hotswapping-clears-data/20288/2)
...
* Adds new regions `Using`, `Lock` and `Lock (Inter-process)` and new node `TempFile [IO]` [forum](https://forum.vvvv.org/t/file-read-write-locks-and-mutex/20063)
...
* Fixed issue with FirmataDevice node [forum](https://forum.vvvv.org/t/arduino-firmata-error-message/20183/4)
* Fixes value modifications on IO boxes potentially modifying the value upstream [forum](https://forum.vvvv.org/t/downstream-bang-triggers-parallel-bang/19947)
* Fixes runtime not always selecting the newest iteration of a patch
* Fixes value tracing not working in static operations [forum](https://forum.vvvv.org/t/value-inspection/20135)
...
* Linking action and symbols now use same code path to determine whether two links are on the same moment [forum](https://forum.vvvv.org/t/double-connections-when-connecting-bcp-to-io-boxes-inside-cache-region/20078)
...
* Fixes pads inside of regions still not getting initialized as advertised in previous version [forum](https://forum.vvvv.org/t/values-of-midi-controllers-are-reset-to-0-in-2021-4-3/20090)
* Fixes complete crash when opening Skia Slideshow help patch [forum](https://forum.vvvv.org/t/skia-example-slideshow-is-crashing-in-gamma-2021-4-4/20124/3)
...
### Changes
* Adds `KeepAppAlive [System]` node [forum](https://forum.vvvv.org/t/hangup-main-thread-while-export-console-app/19736)
...
### Fixes
* Ensures pads inside of regions get initialized with VL defaults [forum](https://forum.vvvv.org/t/values-of-midi-controllers-are-reset-to-0-in-2021-4-3/20090)
* Fixes VL.CoreLib added twice as dependency to new documents 
* Fixes crash after modifying a definition's Summary/Remarks/Tags [forum](https://forum.vvvv.org/t/editing-the-documentation-of-a-class-throws-an-exception/20098)
...
* Fixes regression that patches with output pin groups opened by editor (= debug code path get switched on) would cause emit exception [forum](https://forum.vvvv.org/t/patch-throws-error-from-2021-3-3-to-2021-4-2/20051/2)
* Fixes emit exception when using dictionary builder with apply pin [forum](https://forum.vvvv.org/t/bug-no-overload-for-method-this-takes-2-arguments/20046/3)
...
### Fixes
* Fixes document loading crash in case a dependency contains an invalid file path (see [forum](https://forum.vvvv.org/t/file-does-not-open-nothing-happens/20004))
* Fixes collection editors crashing when displaying value other than `Spread<Spread<T>>` (see [forum](https://forum.vvvv.org/t/2021-4-589-an-iobox-of-type-spread-mutablearray-byte-is-not-drawn-properly-in-patch/19931/2))
...
### Language
* Fixes `X<Y>` not connectable to `Optional<X<Y>>` (see [forum](https://forum.vvvv.org/t/optional-delegates/20024/2))
...
* The compiler uses a different strategy which greatly reduces the compile and hotswap time in bigger projects. For details see [discussion](https://forum.vvvv.org/t/ui-performance-issues/18638) in the forums.
...
* Assemblies of newer frameworks (like net5 or netstandard 2.1) will no longer get picked up, avoiding confusion like [here](https://forum.vvvv.org/t/not-all-nodes-on-update-are-running/19936/2) in the vvvv forums.
