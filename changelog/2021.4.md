...
* Thanks to a new hotswap friendly target code, pressure on the garbage collector is reduced drastically, fixing lot's of glitches/dropouts while running inside of the patch editor. Exported apps are not affected by this change.
