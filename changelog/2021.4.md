...
* added Ray.Sample, Ray.Reflect and a help patch
## New
* GetList same as GetSpread but for IReadOnlyList
* Adds `GetBoundsTransformation` to transform from one rectangle into another
* Skia: Adds `FitToBounds` to fit a path into any bounds
## Fixes
