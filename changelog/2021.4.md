...
### Fixes
* Fixes `LottiePlayer (Skia)`, now smoothly playing animations. Also added `LottiePlayer (Framebased Skia)` - [forum](https://discourse.vvvv.org/t/lottie-playback-not-working-correctly/21006)
...
* Fixes Settings > Themes. Default and Custom themes are better separated - [forum](https://discourse.vvvv.org/t/when-you-add-custom-themes-the-default-themes-are-also-replaced/21019)
