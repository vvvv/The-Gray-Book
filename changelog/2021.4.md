...
## Fixes
* Fixes patch changes inside of recursive patches leading to "X is no X" errors
* Fixes lag when hovering pins in large documents
* Fixes explicit `CreateDefault` operation not being invoked by reflection API
* Fixes binary serialization of classes with abstract field types
...
* Fixes subtle issue in type mapping code of serializers - types were not always mapped to the latest incarnation
...
* Fixes crash in recursive generic patches with custom CreateDefault op
