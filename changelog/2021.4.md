...
* Removed OK and Cancel buttons. Single pin choice mode - which isn't the default any longer - now always picking the shortest node when possible. Open up the NodeBrowser again if you miss a pin.
