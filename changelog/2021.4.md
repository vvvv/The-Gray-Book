...
* A process placed inside of a stateless patch will now produce a warning instead of an error. The warning will tell the user about the short live time of the process.
